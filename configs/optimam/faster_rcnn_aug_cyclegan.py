...
#OMP_NUM_THREADS=1 MKL_NUM_THREADS=1 PYTHONPATH=${PYTHONPATH}:./ python tools/train.py /home/lidia/source/mmdetection/configs/optimam/faster_rcnn_aug_cyclegan.py --work-dir /home/lidia/source/mmdetection/experiments/optimam/hologic/mass/faster_rcnn/train_acr123_no_hstd/no_data_aug_seed_33 --seed 33 --deterministic
#OMP_NUM_THREADS=1 MKL_NUM_THREADS=1 PYTHONPATH=${PYTHONPATH}:./ python tools/train.py /home/lidia/source/mmdetection/configs/optimam/faster_rcnn_aug_cyclegan.py --work-dir /home/lidia/source/mmdetection/experiments/optimam/hologic/mass/faster_rcnn/train_acr123_no_hstd/data_aug_all_csaw_seed_13 --seed 13 --deterministic
