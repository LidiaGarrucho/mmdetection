...
train_pipeline = [
    ...
    #     min_crop_size=0.3),
    dict(type='Resize', img_scale=[(608, 608), (LONGER_EDGE, SHORTER_EDGE)], keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(LONGER_EDGE, SHORTER_EDGE),#(608, 608),
        flip=False,
        transforms=[
...
optimizer = dict(type='SGD', lr=0.00025, momentum=0.9, weight_decay=0.0005) # divided by 4
