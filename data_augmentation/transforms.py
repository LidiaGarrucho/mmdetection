...
from data_augmentation.models import create_model
from data_augmentation.data.base_dataset import get_params, get_transform
import torch 
import cv2, glob
import random
...
class TestOptions:
    def __init__(self, checkpoint_name, gpu_ids):
        ...
        self.checkpoints_dir = '/home/lidia-garrucho/source/mmdetection/data_augmentation/checkpoints'
...
class Low2HighBreastDensityAug:
    #checkpoint_name='high_density_h800', img_scale=(1333, 800)
